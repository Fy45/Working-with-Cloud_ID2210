...
def main():
	...
	fileList = file_list("/Users/fanyuan/Desktop/Task1")
	for fileName in fileList:
		...
		blob = bucket.blob(fileName.replace("/User/fanyuan/Desktop",""))
		...
		blob.download_to_filename(fileName.replace("Task1","Download"))
		endTimed = time.time()
